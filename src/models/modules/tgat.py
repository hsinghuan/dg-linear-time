...
class TGAT(nn.Module):
    ...
    def compute_src_dst_node_temporal_embeddings(
        ...
        neighbors to sample for each node :return:"""
    ...
    def compute_node_temporal_embeddings(
        ...
        temporal embeddings after convolution at the current_layer_num :param node_ids: ndarray,
        shape (batch_size, ) or (*, ), node ids :param node_interact_times: ndarray, shape
        (batch_size, ) or (*, ), node interaction times :param current_layer_num: int, current
        layer number :param num_neighbors: int, number of neighbors to sample for each node
        :return:"""
